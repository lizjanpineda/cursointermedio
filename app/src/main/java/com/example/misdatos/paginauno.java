...
public class paginauno extends AppCompatActivity {
    //otra forma
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        miboton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent miIntent=new Intent(paginauno.this,Main2Activity.class);
    ...
    public void pasapagina2(View view){
        ...
        switch (view.getId()){
            case R.id.button:
               ...
               //para cambiar de activity
                miIntent=new Intent(paginauno.this,Main2Activity.class);
                 break;
